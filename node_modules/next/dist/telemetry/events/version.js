...
if(typeof "9.0.8"!=='string'){return Promise.resolve();}return(0,_storage.record)({eventName:EVENT_VERSION,payload:{nextVersion:"9.0.8",nodeVersion:process.version,cliCommand:event.cliCommand}});}